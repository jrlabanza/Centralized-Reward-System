    ...
    include "includes/header.php";?>
      <div class="container">  
        <div class="row" style="margin-top:40px;">
          <div class="col-lg-12">
            <h1 class="page-header">Confirmation Approval</h1>
            <hr>
          </div>
        </div>
            <div class="card sob">
              ...
              <div class="card-body">  
                <div class="table-responsive">
                  ...
                  $results = $currentEQ->get_current_fixed_eq(); ?>
                    <thead>
                      <tr>
                        <th>Entry No.</th>
                        <th>CID No.</th>
              ...
              <div class="card-footer">
                <input class="btn btn-success eq_fixed_submit "type="submit" name="submit" value="Approved" style="float:right; margin-top:10px;">
              </div> 
            </div>
