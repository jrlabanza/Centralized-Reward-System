          ...
          <div class="col-lg-12 test-header">
            ...
            <div class="card sob">
                ...
                <div class="table-responsive">
                  ...
                  //print_r($results); ?>
                    ...
                    if ($results[$i]['reportType'] == 1)
                    {
                      ...
                      $assosiate = $currentES->associate_data($results[$i]['goodDeedPersonToReward']);
              ...
              <div class="card-footer">
                <input class="btn btn-success es_fixed_submit "type="submit" name="submit" value="Approved" style="float:right; margin-top:10px;">
              </div> 
            </div>
