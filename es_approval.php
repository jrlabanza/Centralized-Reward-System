            ...
            <div class="card sob">
              ...
              <div class="card-body">  
                <div class="table-responsive">
                  ...
                  $results = $currentES->get_current_es();
                  //print_r($results); ?>
                    <thead>
                      <tr>
                        <th>Entry No.</th>
                    ...
                    if ($results[$i]['reportType'] == 1)
                    {
                      ...
                      $assosiate = $currentES->associate_data($results[$i]['category']);
              ...
              <div class="card-footer">
                <input class="btn btn-success es_submit "type="submit" name="submit" value="Approved" style="float:right; margin-top:10px;">
              </div> 
            </div>
